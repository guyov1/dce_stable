function [PKOut OutAIFParam]=AIFTryf(DataToFit,BinCVI,DataNoise,ParamAIFCoeff,nSVols,TimeBetweenDCEVols,Options,ShowFig,AIFFinderFN)
...
%     [MIdxs CXs Sims] = FindKepBATgAIF(DataToFit,SAIF,SHConvd,Keps1I);
    ...
    [PKs Sims] = FindPKBATgAIFMurase(DataToFit,SAIF,SampleTs,CumSumAIFdTSamp);
