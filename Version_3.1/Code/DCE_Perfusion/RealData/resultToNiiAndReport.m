...
Data_Weight_Min                        = Sim_Struct.Data_Weight_Min;
Data_Weight_Max                        = Sim_Struct.Data_Weight_Max;
Data_Weight_Num                        = Sim_Struct.Data_Weight_Num;
...
weight_vector = linspace(Data_Weight_Min, Data_Weight_Max,Data_Weight_Num);

Output_directory_model_selection = [Output_directory filesep 'model_selection'];
mkdir(Output_directory_model_selection);
for i = 1 : numel(weight_vector)
    map_name             = ['Model_Selection_Map_' num2str(weight_vector(i)) '.nii'];
    cur_Data_Weight      = weight_vector(i);
    cur_Output_directory = Output_directory_model_selection;
    chooseModelSelection;
end

% Run one more time with the chosen weight
map_name = 'Model_Selection_Map.nii';
cur_Data_Weight = Data_Weight;
cur_Output_directory = Output_directory;
chooseModelSelection;
