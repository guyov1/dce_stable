...
Defaults.Correct_estimation_due_to_delay       = 0;
...
Defaults.Max_Time_Delay                        = +5.0;
ParamToolTips.Max_Time_Delay                   = ['Max_Time_Delay: Max BAT to search.' 10 'Default: +5.0'];
Defaults.Force_RealData_Calc                   = 0;
ParamToolTips.Force_RealData_Calc              = ['Force_RealData_Calc: Force calculation if already calculated.' 10 'Default: 0'];
...
Defaults.Upsampling_resolution_Sec       = 0.5;
