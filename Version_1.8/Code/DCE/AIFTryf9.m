function [PKOut OutAIFParam]=AIFTryf(WorkingP,DataToFit,MaxAmp,DataNoise,ParamAIFCoeff,nSVols,TimeBetweenDCEVols,AOptions,ShowFig,AIFFinderFN,TimeVec,Handle)
