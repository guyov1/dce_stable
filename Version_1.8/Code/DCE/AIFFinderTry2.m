...
[CVI, BinCVI, Bin2CVI]=ChooseRepVoxelsForAIFFind(Msk3D,MskE,CTC2D,BolusStart,Options.Rep_MaxAroundBolus,Options.Rep_RatioToEnd,Options.Rep_nPerSet);
...
%%
MskCTC=Idx3D>0;
MskCTC2=MskCTC & ApproximatePeakTime<median(ApproximatePeakTime1D);
F1=find(MskCTC);
F2=find(MskCTC2);
F3=find(ismember(F1,F2));
CTC2D2=CTC2D(F3,:);
[CVI2, BinCVI2, Bin2CVI2]=ChooseRepVoxelsForAIFFind(MskCTC2,MskE,CTC2D2,BolusStart,Options.Rep_MaxAroundBolus,Options.Rep_RatioToEnd,Options.Rep_nPerSet);
