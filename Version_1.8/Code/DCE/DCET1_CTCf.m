...
% TmpA=DBrainMask*0;
% TmpA(DBrainMask)=BaselineFA3D(DBrainMask);
% mricront(TmpA)
% mricront(DCEFA*Tmp./TmpA)
%%
...
%     CurT1=DCEVolToT1(FA3D,DCEM0,CurVol);
    CurT1=DCEVolToT1(BaselineFA3D,M03D,CurVol);
...
NearVals=[DCE4DX(sub2ind(size(DCE4D),I,J,K,PeakTime(GoodPeak)-1)) DCE4DX(sub2ind(size(DCE4D),I,J,K,PeakTime(GoodPeak)+1))];
...
clear 7340032 BaselineB1Fld Baseline BaselineFA3D CurT1 B1Nok FA3DNoB1Nok CurVol
%% Clearing vars
