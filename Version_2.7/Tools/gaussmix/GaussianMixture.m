function [mixture, optmixture, tElapsed] = GaussianMixture(pixels, initK, finalK, verbose)
% [mixture, optmixture] = GaussianMixture(pixels, initK, finalK, verbose)
...
if(size(pixels,1)<2) % g
    error('GaussianMixture: Nead at least 2 samples');
end
