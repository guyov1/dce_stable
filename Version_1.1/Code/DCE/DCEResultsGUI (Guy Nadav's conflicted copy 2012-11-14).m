...
BATIdx=1;
for i=1:numel(Idxs)
    SHConvd2(i,:)=interp1(handles.HSampleTs,HConvd2(i,:)',handles.HSampleTs-handles.PKs(Idxs(i),BATIdx)/60,[],'extrap')';
    SHSAIF(i,:)=interp1(handles.HSampleTs,handles.HAIF,handles.HSampleTs-handles.PKs(Idxs(i),BATIdx)/60,[],'extrap');
end
%
VpIdx=2;
KtransIdx=3;
