...
plot(HSampleTs*60,HAIF,'k','LineWidth',2);
for k=1:(HInterpolationFactor)
    plot((SampleTs+TimeToStart(k))*60,SmpAIF(k,:)-MaxAmp*k,'-*','Color',ones(1,3)*0.7);
end
...
saveas(301,'SamplingOfAIFrMean.fig');
saveas(301,'SamplingOfAIFrMean.png');