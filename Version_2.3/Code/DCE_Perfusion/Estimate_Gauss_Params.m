function [est_sigma_noise, est_t_d_noise, est_amp_noise,  idx_fig ] = Estimate_Gauss_Params( Sim_Struct, ht_Struct , est_gauss_filter_Wiener_noise, Verbosity, iter_num, avg_num, idx_fig)
