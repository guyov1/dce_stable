function [PKOut OutAIFParam]=AIFTryf(WorkingP,DataToFit,MaxAmp,DataNoise,ParamAIFCoeff,nSVols,TimeBetweenDCEVols,AOptions,ShowFig,AIFFinderFN,TimeVec)
...
[OldParams1,resnorm,residual,exitflag,output] = lsqcurvefit(AIF_Parker8tx,X0',double(SampleTs),MeanVessel,LB, UB,options);
...
saveas(1000,[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '.fig']);
saveas(1000,[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '.png']);
close(1000);
Tmp=[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '.png'];
...
%    saveas(100+kk,[AIFFinderFN(1:end-4) '_FitOnArt_' num2str(kk) '.png']);
    saveas(100+kk,[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '_FitOnArt_' num2str(kk) '.fig']);
    saveas(100+kk,[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '_FitOnArt_' num2str(kk) '.png']);
    close(100+kk);
%    Tmp=[AIFFinderFN(1:end-4) '_FitOnArt_' num2str(kk) '.png'];
    Tmp=[regexprep(AIFFinderFN(1:end-4),'\zqzqzqzq.','_') '_FitOnArt_' num2str(kk) '.png'];
