...
[ridge_regression_gauss_result, b_spline_gauss_result, b_spline_gauss_result_1st_deriv, b_spline_gauss_result_2nd_deriv, b_PCA_gauss_result_1st_deriv, b_PCA_gauss_result_2nd_deriv, Sim_Struct.idx_fig]...
    ...
    lambda_vec_gauss, normalize, Upsampling_resolution, B_mat_upsmp, plot_L_Curve, Sim_Struct.idx_fig , 'Gauss' , Derivative_Time_Devision, plot_flag, RealData_Flag );
...
[ridge_regression_larss_result, b_spline_larss_result, b_spline_larss_result_1st_deriv, b_spline_larss_result_2nd_deriv, b_PCA_gauss_result_1st_deriv, b_PCA_gauss_result_2nd_deriv, Sim_Struct.idx_fig]...
    ...
    lambda_vec_larss, normalize, Upsampling_resolution, B_mat_upsmp, plot_L_Curve, Sim_Struct.idx_fig , 'Larss' , Derivative_Time_Devision, plot_flag, RealData_Flag );
