...
if(isfield(CurFullInfo,'NumberOfTemporalPositions'))
...
CSFMask=BaseSeg3DAll==3 & BaseSeg3D(:,:,:,3)>0.99 & EEEBrainMask==1;
WMMask=BaseSeg3DAll==2 & BaseSeg3D(:,:,:,2)>0.99 & EEEBrainMask==1;
