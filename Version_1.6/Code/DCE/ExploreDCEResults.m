...
Titles={'MeanVol' 'Kep','BAT','Vp','Ktrans','Ve' 'F' 'F0' 'TimeP' 'Msk' 'maxC' 'Noise' 'Enhancement%' 'RMS' 'rRMS3D' 'RMStoNoise' 'T1','B1' 'WhichModel'};
TTL=PKM3DFN;
DCEResultsGUI({MeanVol Kep3D BAT3D Vp3D Ktrans3D Ve3D -log10(F3D) -log10(F03D) TP3D MskCTCGood3D MaxConcentration3D Noise3D (MaxRatioToBaseline-1)*100 RMS3D rRMS3D RMStoNoise3D FinalT1 B1 WhichModel3D},Titles,MskCTCGood3D,CTC2DBigGood(:,GoodTIdxs),Idx3DBig,1,PKs,1,1,1,SampleTs,HSampleTs,HAIF,TTL,TDif);
