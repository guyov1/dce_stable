...
%                   J2,nterms,gridsize1,gridsize2, ...
%                   varyfactor,ridgecoef,type,varest,coef,bandspan) ;
%
%
%  
...
msehat = zeros(m,1) ;
   ...
   [f,var]=lpolybiv(x,y,h2(:,k),xgrid,order,p,varyfactor,ridgecoef,0) ;
   fvect(:,k) = f ;
   var2(:,k) = var ;
   end ;
...
[f,var]=lpolybiv(x,y,band,xgridb,order,p,varyfactor,ridgecoef,0) ;
