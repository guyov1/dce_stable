...
% $Revision: 1.2 $
  ...
  wfu_require_tbx_common;  %called as this may be called as a stand alone function
...
cube_coords = round(inv(v.mat) * mni_coords);
...
%{
$Log: wfu_extract_labels.m,v $
Revision 1.2  2010/07/26 19:29:48  bwagner
WFU_LOG intergrated.  Added round to cub_coords for users not using a 2mm iso. atlas.

revision 1.1  2009/10/09 18:08:44  bwagner
